...
async function sendEmail(to, subject, html) {
  ...
  if (!to) { console.warn("[Email] No recipient email — skipping"); return; }
  ...
  const finalSubject = DOMAIN_VERIFIED ? subject : `[For: ${to}] ${subject}`;

  console.log(`[Email] Sending to=${recipient} domain_verified=${DOMAIN_VERIFIED} subject="${subject}"`);
...
module.exports = { sendEmail, sendDepositConfirmed, sendWithdrawalApproved, sendWithdrawalRejected, sendKYCVerified, sendKYCRejected };
